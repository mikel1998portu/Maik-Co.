document.addEventListener('DOMContentLoaded', function() {
    ...
    const knowledgeBase = {
        ...
        'comisiones': 'Para profesionales, aplicamos una comisión base del 15% por servicio, con descuentos por volumen. Para clientes, no hay comisiones adicionales al precio acordado con el profesional.',
